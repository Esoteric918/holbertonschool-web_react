import { getAllNotificationsByUser, notifSchema } from "./notifications";
...
describe("getAllNotificationsByUser", () => {
  ...
  it("Checks if notifSchema is correct", () => {
    expect(notifSchema.result).toEqual(res);
  });
  ...
  it("Verifies that normalized data has correct messages entity for given guid", () => {
    ...
    expect(notifSchema.entities.messages[message]).toEqual({
  ...
  it("Verifies that normalized data has correct users entity for given id", () => {
    ...
    expect(notifSchema.entities.notifications[user]).toEqual({
